import os #estructura de directorios
import numpy # trabajar con matrices, matrices multidimencionales
import sys # manipulacion del nombre del script
...
path = sys.path[0]
print(path)
dir_faces = path + '/att_faces/orl_faces'
print(dir_faces)
...
if not os.path.isdir(path):
    os.mkdir(path)
    print("se creo carpeta")
#os.mkdir(path+'/'+ nombre)

#cargamos la plantilla
face_cascade = cv2.CascadeClassifier('clasificador/cascade.xml')
#Tamaño para reducir a miniaturas las fotografias
size = 4
#abrimos video con opencv
